...
import com.gepc.proyectosensores.databinding.ActivityModificarSensoresUoBinding;
...
public class ModificarSensores_UO extends BasedelMenuOpcUOperador {
    ActivityModificarSensoresUoBinding activityModificarSensoresUoBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modificar_sensores_uo);

        activityModificarSensoresUoBinding = ActivityModificarSensoresUoBinding.inflate(getLayoutInflater());
        setContentView( activityModificarSensoresUoBinding.getRoot());
        ...
        retornar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intenregresar_menu = new Intent(ModificarSensores_UO.this, com.gepc.proyectosensores.RegistroSensores_UO.class);
        ...
        modificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pdDialog= new ProgressDialog(ModificarSensores_UO.this);
