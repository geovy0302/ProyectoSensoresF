...
import com.gepc.proyectosensores.databinding.ActivityDatosPorSensoPfUoBinding;
...
public class DatosPorSensoPF_UO extends BasedelMenuOpcUOperador {
    ActivityDatosPorSensoPfUoBinding activityDatosPorSensoPfUoBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_datos_por_senso_pf_uo);
        activityDatosPorSensoPfUoBinding = ActivityDatosPorSensoPfUoBinding.inflate(getLayoutInflater());
        setContentView( activityDatosPorSensoPfUoBinding.getRoot());
        ...
        Retornar1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intenbuscaruser = new Intent(DatosPorSensoPF_UO.this, com.gepc.proyectosensores.DatosPorSensor_UO.class);
