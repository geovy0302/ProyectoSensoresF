...
import com.gepc.proyectosensores.databinding.ActivityModificarTipoSensorUaBinding;
...
public class ModificarTipoSensor_UA extends BasedelMenuOpcUAdmin {
    ActivityModificarTipoSensorUaBinding activityModificarTipoSensorUaBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modificar_tipo_sensor_ua);

        activityModificarTipoSensorUaBinding = ActivityModificarTipoSensorUaBinding.inflate(getLayoutInflater());
        setContentView( activityModificarTipoSensorUaBinding.getRoot());
        ...
        idlocali.setText(""+ RegistrodeTipodeSensores_UA.listaTotal.get(position).getView_IdTipoSensor());
        nombreLocali.setText(""+ RegistrodeTipodeSensores_UA.listaTotal.get(position).getView_Nombre_TipoSensor());

        retornar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intenregresar_menu = new Intent(ModificarTipoSensor_UA.this, com.gepc.proyectosensores.RegistrodeTipodeSensores_UA.class);
        ...
        modificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pdDialog= new ProgressDialog(ModificarTipoSensor_UA.this);
