...
import com.gepc.proyectosensores.databinding.ActivityRegistroSensoresUoBinding;
...
public class RegistroSensores_UO extends BasedelMenuOpcUOperador {
    ActivityRegistroSensoresUoBinding activityRegistroSensoresUoBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registro_sensores_uo);

        activityRegistroSensoresUoBinding = ActivityRegistroSensoresUoBinding.inflate(getLayoutInflater());
        setContentView( activityRegistroSensoresUoBinding.getRoot());
        ...
        añadir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intenbuscaruser = new Intent(RegistroSensores_UO.this, com.gepc.proyectosensores.AgregarSensoR_UO.class);
        ...
        retornar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intenbuscaruser = new Intent(RegistroSensores_UO.this, com.gepc.proyectosensores.MenudeInforSenso_UO.class);
                startActivity(intenbuscaruser);
                finish();
            }
        });
                                ...
                                public void onItemClick(View view, int position) {
                                    ...
                                    builder.setItems(dialogItem, new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int opcion) {
                                            switch (opcion){
                                                case 0:
                                                    startActivity(new Intent(getApplicationContext(), MostrarSensores_UO.class).
                                                ...
                                                case 1:
                                                    ...
                                                    break;
                                                case 2:
                                                    startActivity(new Intent(getApplicationContext(), ModificarSensores_UO.class).
                                                            putExtra("position", position));
                                                    finish();
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            if(successAux.equals("logrado")){
                                ...
                                startActivity(new Intent(getApplicationContext(),RegistroSensores_UO.class));
                                finish();
                            }else{
