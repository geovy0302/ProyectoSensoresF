...
public class MostrarInfoSensores_UO extends BasedelMenuOpcUOperador {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mostrar_info_sensores_uo);
        ...
        retornar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intenregresar_menu = new Intent(MostrarInfoSensores_UO.this, com.gepc.proyectosensores.BusquedaSensores_UO.class);
