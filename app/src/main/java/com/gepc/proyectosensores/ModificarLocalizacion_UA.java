...
import com.gepc.proyectosensores.databinding.ActivityModificarLocalizacionUaBinding;
...
public class ModificarLocalizacion_UA extends BasedelMenuOpcUAdmin {
    ActivityModificarLocalizacionUaBinding activityModificarLocalizacionUaBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modificar_localizacion_ua);

        activityModificarLocalizacionUaBinding = ActivityModificarLocalizacionUaBinding.inflate(getLayoutInflater());
        setContentView( activityModificarLocalizacionUaBinding.getRoot());
        ...
        idlocali.setText(""+ RegistrodeSensores_UA.listaTotal.get(position).getView_IdLocalizacion());
        nombreLocali.setText(""+ RegistrodeSensores_UA.listaTotal.get(position).getView_Nombre_Localizacion());

        retornar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intenregresar_menu = new Intent(ModificarLocalizacion_UA.this, com.gepc.proyectosensores.RegistrodeSensores_UA.class);
        ...
        modificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pdDialog= new ProgressDialog(ModificarLocalizacion_UA.this);
