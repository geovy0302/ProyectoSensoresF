...
import com.gepc.proyectosensores.databinding.ActivityAgregarSensoRuoBinding;
...
public class AgregarSensoR_UO extends BasedelMenuOpcUOperador {
    ActivityAgregarSensoRuoBinding activityAgregarSensoRuoBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agregar_senso_ruo);

        activityAgregarSensoRuoBinding = ActivityAgregarSensoRuoBinding.inflate(getLayoutInflater());
        setContentView( activityAgregarSensoRuoBinding.getRoot());
        ...
        retornar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intenregresar_menu = new Intent(AgregarSensoR_UO.this, com.gepc.proyectosensores.RegistroSensores_UO.class);
        ...
        modificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pdDialog= new ProgressDialog(AgregarSensoR_UO.this);
                ...
                {
                    pdDialog.dismiss();
                    Toast.makeText(AgregarSensoR_UO.this," Campos Vacíos, Por favor completelos ",Toast.LENGTH_SHORT).show();
                }else{
                    Registrar();
                }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ArrayAdapter<ClaseGlobalLocalizaciones> adapterLocakizaciones = new ArrayAdapter<ClaseGlobalLocalizaciones>(AgregarSensoR_UO.this,android.R.layout.simple_dropdown_item_1line,arrayLocaliazciones);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ArrayAdapter<TiposDeSensoresUni> adapterTipoSensores = new ArrayAdapter<TiposDeSensoresUni>(AgregarSensoR_UO.this,android.R.layout.simple_dropdown_item_1line,arrayTipoSensores);
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            if(success.equals("success 2")){
                                ...
                                Intent intenregresar_menu = new Intent(AgregarSensoR_UO.this, com.gepc.proyectosensores.AgregarSensoR_UO.class);
                                startActivity(intenregresar_menu);
                                finish();
                            }
