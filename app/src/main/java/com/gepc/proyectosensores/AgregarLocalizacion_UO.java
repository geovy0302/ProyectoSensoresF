...
import com.gepc.proyectosensores.databinding.ActivityAgregarLocalizacionUoBinding;
...
public class AgregarLocalizacion_UO extends BasedelMenuOpcUOperador {
    ActivityAgregarLocalizacionUoBinding activityAgregarLocalizacionUoBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agregar_localizacion_uo);
        activityAgregarLocalizacionUoBinding = ActivityAgregarLocalizacionUoBinding.inflate(getLayoutInflater());
        setContentView( activityAgregarLocalizacionUoBinding.getRoot());
        ...
        retornar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intenregresar_menu = new Intent(AgregarLocalizacion_UO.this, com.gepc.proyectosensores.RegistrodeSensores_UO.class);
        ...
        Añadirlocali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pdDialog= new ProgressDialog(AgregarLocalizacion_UO.this);
                pdDialog.setTitle(" Regitrando los datos de la Localización...");
                pdDialog.setCancelable(false);
                if(nombreLocaliza.isEmpty())
                {
                    pdDialog.dismiss();
                    Toast.makeText(AgregarLocalizacion_UO.this," Campos Vacíos, Por favor completelos ",Toast.LENGTH_SHORT).show();
                }else{
                    Registrar();
                }
            }
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            if(success.equals("success 2")){
                                ...
                                Intent intenregresar_menu = new Intent(AgregarLocalizacion_UO.this, com.gepc.proyectosensores.AgregarLocalizacion_UO.class);
                                startActivity(intenregresar_menu);
                                finish();
                            }
