...
import com.gepc.proyectosensores.databinding.ActivityModificarSensoresUaBinding;
...
public class ModificarSensores_UA extends BasedelMenuOpcUAdmin {
     ActivityModificarSensoresUaBinding activityModificarSensoresUaBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modificar_sensores_ua);

        activityModificarSensoresUaBinding = ActivityModificarSensoresUaBinding.inflate(getLayoutInflater());
        setContentView( activityModificarSensoresUaBinding.getRoot());
        ...
        retornar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intenregresar_menu = new Intent(ModificarSensores_UA.this, com.gepc.proyectosensores.RegistroSensores_UA.class);
        ...
        modificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pdDialog= new ProgressDialog(ModificarSensores_UA.this);
