...
import com.gepc.proyectosensores.databinding.ActivityBusquedaSensoresUaBinding;
...
public class BusquedaSensores_UA extends BasedelMenuOpcUAdmin {
    ActivityBusquedaSensoresUaBinding activityBusquedaSensoresUaBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_busqueda_sensores_ua);


        activityBusquedaSensoresUaBinding = ActivityBusquedaSensoresUaBinding.inflate(getLayoutInflater());
        setContentView( activityBusquedaSensoresUaBinding.getRoot());
        ...
        retornar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intenbuscaruser = new Intent(BusquedaSensores_UA.this, com.gepc.proyectosensores.MenudeInforSenso_UA.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ArrayAdapter<ClaseGlobalLocalizaciones> adapterLocakizaciones = new ArrayAdapter<ClaseGlobalLocalizaciones>(BusquedaSensores_UA.this,android.R.layout.simple_dropdown_item_1line,arrayLocaliazciones);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ArrayAdapter<TiposDeSensoresUni> adapterTipoSensores = new ArrayAdapter<TiposDeSensoresUni>(BusquedaSensores_UA.this,android.R.layout.simple_dropdown_item_1line,arrayTipoSensores);
                                    ...
                                    public void onItemClick(View view, int position) {
                                        ...
                                        builder.setItems(dialogItem, new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int opcion) {
                                                switch (opcion){
                                                    case 0:
                                                    startActivity(new Intent(getApplicationContext(), MostrarInfoSensores_UA.class).
                                                    ...
                                                    EliminarDatos(IdAuxiliar);
                                                        break;
                                                    case 2:
                                                        startActivity(new Intent(getApplicationContext(), ModificarInfoSensores_UA.class).
                                                                putExtra("position", position));
                                                        finish();
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            if(successAux.equals("logrado")){
                                ...
                                startActivity(new Intent(getApplicationContext(),BusquedaSensores_UA.class));
                                finish();
                            }else{
