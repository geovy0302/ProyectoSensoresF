...
import com.gepc.proyectosensores.databinding.ActivityModificarInfoSensoresUoBinding;
...
public class ModificarInfoSensores_UO extends BasedelMenuOpcUOperador {
    ActivityModificarInfoSensoresUoBinding activityModificarInfoSensoresUoBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modificar_info_sensores_uo);

        activityModificarInfoSensoresUoBinding = ActivityModificarInfoSensoresUoBinding.inflate(getLayoutInflater());
        setContentView( activityModificarInfoSensoresUoBinding.getRoot());
        ...
        idUser.setText(""+ BusquedaSensores_UO.listaTotal.get(position).getView_ID_Sensor());
        nombreUser.setText(""+ BusquedaSensores_UO.listaTotal.get(position).getView_Nombre_DelSensor());
        loginUser.setText(""+ BusquedaSensores_UO.listaTotal.get(position).getView_COOR_LATITUD());
        telefono_user.setText(""+ BusquedaSensores_UO.listaTotal.get(position).getView_COOR_LONGITUD());
        Edad_user.setText(""+ BusquedaSensores_UO.listaTotal.get(position).getView_localizacionSensor());
        PasswordUser.setText(""+ BusquedaSensores_UO.listaTotal.get(position).getView_tipodeSensores());

        retornar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intenregresar_menu = new Intent(ModificarInfoSensores_UO.this, com.gepc.proyectosensores.BusquedaSensores_UO.class);
        ...
        modificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pdDialog= new ProgressDialog(ModificarInfoSensores_UO.this);
