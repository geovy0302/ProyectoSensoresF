...
import com.gepc.proyectosensores.databinding.ActivityEscogerLtsManualAdminBinding;
...
public class Escoger_LTS_Manual_Admin extends BasedelMenuOpcUAdmin {
    ActivityEscogerLtsManualAdminBinding activityEscogerLtsManualAdminBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_escoger_lts_manual_admin);

        activityEscogerLtsManualAdminBinding = ActivityEscogerLtsManualAdminBinding.inflate(getLayoutInflater());
        setContentView( activityEscogerLtsManualAdminBinding.getRoot());
        ...
        buscarDatosPorLocaliyTipo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BuscarElSensor.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intenbuscaruser = new Intent(Escoger_LTS_Manual_Admin.this, com.gepc.proyectosensores.Insercion_Datos_Manuales_UA.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ArrayAdapter<ClaseGlobalLocalizaciones> adapterLocakizaciones = new ArrayAdapter<ClaseGlobalLocalizaciones>(Escoger_LTS_Manual_Admin.this,android.R.layout.simple_dropdown_item_1line,arrayLocaliazciones);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ArrayAdapter<TiposDeSensoresUni> adapterTipoSensores = new ArrayAdapter<TiposDeSensoresUni>(Escoger_LTS_Manual_Admin.this,android.R.layout.simple_dropdown_item_1line,arrayTipoSensores);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(array.length()>0){
                                ...
                                ArrayAdapter<nombreSensorBuscar> adapterSensorBuscar = new ArrayAdapter<nombreSensorBuscar>(Escoger_LTS_Manual_Admin.this,android.R.layout.simple_dropdown_item_1line,arraySensoresBuscar);
